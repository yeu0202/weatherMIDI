...
//  // read the sensor values here 
//  windSensorValue = 1; // 0-200
//  temperatureSensorInValue = 20; // -10 - 40
//  temperatureSensorOutValue = 30; // -10 - 40
//  humiditySensorValue = 40; // 0-100
//  lightSensorValue = 50; // 0 - 1023
//  barometricSensorValue = 99910; // Can also keep track of barometric data history, to see in what way is it changing. Also might not need to retrieve every loop
//  // 99900 - 102000
...
//  Serial.println(serialOutput);
  ...
  windSensorValue = 200 - windSensorValue;
